    ...
    $("#updateBtn").click(function () {
        ...
        $.ajax({
            ...
            success:function (result) {
                ...
                if(result.issuccess){
                    layer.msg("修改成功",{time:3000,icon:6,anim:1});
                    window.location.href="${APP_PATH}/user/toIndex.htm";
                }else{

                    layer.msg(result.message,{time:3000,icon:5,anim:3});
                }
            },
            error:function () {
                layer.msg("修改错误",{time:1000,icon:5,anim:3});
            }
