        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form role="form" id="ffrom">
                        <div class="form-group">
                            <label for="furl">管理URL</label>
                            <input type="text" class="form-control" id="furl" value="${permission.url}" placeholder="请输入url">
                        </div>

                        <div class="form-group">
                            <label for="furl">选择图标</label>
                            <select class="form-control"  id="ficon">
                                <c:forEach items="${icons}" var="obj">
                                    <option value="${obj.icon}"
                                    <c:if test="${obj.icon eq permission.icon}">selected</c:if>
                                    >${obj.icon}
                                    </option>
                                </c:forEach>
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="${permission.name}"  id="fname" placeholder="请输入权限名称">
                        </div>
        ...
        $.ajax({
            ...
            success:function (result) {
                if(result.issuccess){
                    ...
                    layer.msg("修改成功",{time:1000,icon:6,anim:1});
            ...
            error:function () {
                layer.msg("修改错误",{time:3000,icon:5,anim:1})
            }
