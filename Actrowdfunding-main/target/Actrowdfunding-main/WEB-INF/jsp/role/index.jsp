            ...
            success:function (result) {
                ...
                if(result.issuccess){
                    ...
                    if(page.pageNum==1){
                        ...
                        tar+='<li><a href="#" onclick="pageChange('+(page.pageNum - 1)+')">上一页</a></li>';
                    }
                    ...
                    if(page.pageNum==page.pages){
                        ...
                        tar+=' <li><a href="#" onclick="pageChange('+(page.pageNum + 1)+')">下一页</a></li>';
                    }
                    tar+="<span class='label label-info'>"+"第"+page.pageNum+"/"+page.pages+"页"+"</span>";
                    tar+="<span class='label label-info'>"+"共"+page.total+"条数据"+"</span>";
