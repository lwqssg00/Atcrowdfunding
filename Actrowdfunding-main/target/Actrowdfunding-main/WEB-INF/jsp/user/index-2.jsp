                ...
                <div class="panel-body">
                    ...
                    <div class="table-responsive">
                        <table class="table  table-bordered">
                            ...
                            <tbody>
                            <c:forEach items="${page.datas}" var="user" varStatus="userState">
                            <tr>
                                <td>${userState.count}</td>
...
<script type="text/javascript">
    ...
    function pageChange(pageno) {
        window.location.replace("${APP_PATH}/user/queryUser.do?pageno="+pageno);
